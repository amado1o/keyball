...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DEFAULT] = LAYOUT_universal(
    KC_TAB   , KC_SCLN  , KC_DOT   , KC_COMM  , KC_P     , KC_Q     ,                                        KC_Y     , KC_G     , KC_D     , KC_M     , KC_F     , KC_BSPC  ,
    KC_LCTL  , KC_A     , KC_O     , KC_E     , KC_I     , KC_U     ,                                        KC_B     , KC_N     , KC_T     , KC_R     , KC_S     , KC_QUOT  ,
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_W     ,                                        KC_H     , KC_J     , KC_K     , KC_L     , KC_MINS  , KC_INT1  ,
